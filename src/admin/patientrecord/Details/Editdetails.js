        ...
        const fetchDentalAndMedDetails = async () => {
            try{
                const { data, dataandmederror } = await supabase
                    ...
                    setDentalAndMed({                    
                        patient_prevdentist: data.patient_prevdentist,
                        patient_lastdentalvisit: data.patient_lastdentalvisit,
                        patient_physicianname: data.patient_physicianname,
                        patient_physicianspecialty: data.patient_physicianspecialty,
                        patient_physicianaddress: data.patient_physicianaddress,
                        patient_physiciannumber: data.patient_physiciannumber,
                        isInGoodHealth: data.isInGoodHealth || false,
                        isInMedTreatment: data.isInMedTreatment || false,
                        everHadIllness: data.everHadIllness || false,
                        everBeenHospitalized: data.everBeenHospitalized || false,
                        isTakingMedication: data.isTakingMedication || false,
                        isUsingTobacco: data.isUsingTobacco || false,
                        isUsingDrugs: data.isUsingDrugs || false,
                        allergicToLocalAnesthetic: data.allergicToLocalAnesthetic || false,
                        allergicToPenicillin: data.allergicToPenicillin || false,
                        allergicToLatex: data.allergicToLatex ,
                        allergicToSulfaDrugs: data.allergicToSulfaDrugs,
                        allergicToAspirin: data.allergicToAspirin,
                        allergicToCodeine: data.allergicToCodeine,
                        allergicToNovocain: data.allergicToNovocain,
                        illnessHeartDisease: data.illnessHeartDisease || false,
                        illnessAnemia: data.illnessAnemia || false,
                        illnessAcidReflux: data.illnessAcidReflux || false,
                        illnessHeartFailure: data.illnessHeartFailure || false,
                        illnessLeukemia: data.illnessLeukemia || false,
                        illnessStomachUlcer: data.illnessStomachUlcer || false,
                        illnessAngina: data.illnessAngina || false,
                        illnessHivAids: data.illnessHivAids || false,
                        illnessAutoimmune: data.illnessAutoimmune || false,
                        illnessMitralValve: data.illnessMitralValve || false,
                        illnessFainting: data.illnessFainting || false,
                        illnessThyroid: data.illnessThyroid || false,
                        illnessRheumatic: data.illnessRheumatic || false,
                        illnessLung: data.illnessLung || false,
                        illnessFibromyalgia: data.illnessFibromyalgia || false,
                        illnessCongenitalHeart: data.illnessCongenitalHeart || false,
                        illnessAsthma: data.illnessAsthma || false,
                        illnessArthritis: data.illnessArthritis || false,
                        illnessArtificialHeart: data.illnessArtificialHeart || false,
                        illnessEmphysema: data.illnessEmphysema || false,
                        illnessOsteoporosis: data.illnessOsteoporosis || false,
                        illnessHeartSurgery: data.illnessHeartSurgery || false,
                        illnessTuberculosis: data.illnessTuberculosis || false,
                        illnessPsychiatric: data.illnessPsychiatric || false,
                        illnessPacemaker: data.illnessPacemaker || false,
                        illnessCancer: data.illnessCancer || false,
                        illnessEpilepsy: data.illnessEpilepsy || false,
                        illnessHighblood: data.illnessHighblood || false,
                        illnessRadiation: data.illnessRadiation || false,
                        illnessCerebralPalsy: data.illnessCerebralPalsy || false,
                        illnessStroke: data.illnessStroke || false,
                        illnessChemotherapy: data.illnessChemotherapy || false,
                        illnessDiabetes: data.illnessDiabetes || false,
                        illnessKidney: data.illnessKidney || false,
                        illnessBleedingProblem: data.illnessBleedingProblem || false,
                        illnessLiver: data.illnessLiver || false,
                        illnessHemophilia: data.illnessHemophilia || false,
                        illnessHepatitisAb: data.illnessHepatitisAb || false,
                        illnessHepatitisC: data.illnessHepatitisC || false,
                        isPregnant: data.isPregnant || false,
                        isNursing: data.isNursing || false,
                        isTakingPills: data.isTakingPills || false
                    })
