...
const Patientsettings = () => {
    ...
    const firstName = profileDetails.patient_fname ? capitalizeFirstLetter(profileDetails.patient_fname) : '';

    const middleName = profileDetails.patient_mname ? capitalizeFirstLetter(profileDetails.patient_mname) : '';

    // Format last name with first letter capitalized, or default text if not provided
    const lastName = profileDetails.patient_lname ? capitalizeFirstLetter(profileDetails.patient_lname) : '';

    // Format branch name with all letters capitalized, or default text if not provided
    const branch = profileDetails.patient_branch ? capitalizeAllLetters(profileDetails.patient_branch) : 'Branch not provided';
